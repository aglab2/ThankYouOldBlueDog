...
const GeoLayout bbh_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5364, -846, 4823, 0, 45, 0, bbh_dl_island_001_mesh_layer_1),
		...
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, bbh_dl_Plane_001_mesh_layer_5),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, bbh_dl_Plane_002_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};

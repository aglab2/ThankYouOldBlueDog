...
const LevelScript level_wf_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_WF_MOVE_SAFE, wf_movesafe_geo), 
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 0, 819, 0, 0, 0, 0, (0xa << 16), bhvWfCtl),
		OBJECT(MODEL_NONE, -2, 557, -19, 0, -90, 0, (0xa << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_STAR, -3, 3763, -28, 0, 0, 0, 0x00000000, bhvStar),
		TERRAIN(wf_area_1_collision),
		MACRO_OBJECTS(wf_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_MAGIC),

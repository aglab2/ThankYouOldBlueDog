...
void scroll_ddd_dl_Plane_004_mesh_layer_4_vtx_0() {
	int i = 0;
	int count = 4;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(ddd_dl_Plane_004_mesh_layer_4_vtx_0);
...
void scroll_ddd_dl_Plane_004_mesh_layer_4_vtx_1() {
	int i = 0;
	int count = 16;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(ddd_dl_Plane_004_mesh_layer_4_vtx_1);

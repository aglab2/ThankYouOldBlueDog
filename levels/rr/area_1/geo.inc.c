...
const GeoLayout rr_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -126, 0, rr_dl_Plane_016_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -126, 0, rr_dl_Plane_018_mesh_layer_5),

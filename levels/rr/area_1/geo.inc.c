...
const GeoLayout rr_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 1822, -2527, 12943, 0, 90, 0, rr_dl_Cube_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -126, 0, rr_dl_o_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -126, 0, rr_dl_o1_mesh_layer_5),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1533, 0, 0, rr_dl_ow_014_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, rr_dl_ow_014_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -11853, 0, 0, rr_dl_ow_015_mesh_layer_5),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -126, 0, rr_dl_Plane_014_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, rr_dl_Plane_015_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_ALPHA, rr_dl_Plane_016_mesh_layer_4),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -100, 0, rr_dl_Plane_018_mesh_layer_1),

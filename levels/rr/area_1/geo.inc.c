...
const GeoLayout rr_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 2963, -1566, -3787, 82, 0, 0, rr_dl_Plane_012_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, rr_dl_Plane_012_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1649, -3331, -3090, rr_dl_Plane_013_mesh_layer_1),

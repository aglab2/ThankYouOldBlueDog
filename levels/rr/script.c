...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(MODEL_NONE, 13631, -188, 12933, 0, 0, 0, 0x00000000, bhvCcmFlipper),
		OBJECT(MODEL_NONE, 12931, -188, 12933, 0, 0, 0, 0x00000000, bhvCcmFlipper),
		OBJECT(MODEL_NONE, 12231, -188, 12933, 0, 0, 0, 0x00000000, bhvCcmFlipper),
		OBJECT(MODEL_NONE, 11531, -188, 12933, 0, 0, 0, 0x00000000, bhvCcmFlipper),
		OBJECT(MODEL_NONE, 10831, -188, 12933, 0, 0, 0, 0x00000000, bhvCcmFlipper),
		OBJECT(MODEL_NONE, 10131, -188, 12933, 0, 0, 0, 0x00000000, bhvCcmFlipper),
		MARIO_POS(0x01, 0, 2437, 85, -13066),
		...
		OBJECT(MODEL_NONE, 14534, 85, -13127, 0, 0, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, -10002, 85, -15290, 0, 0, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, -13551, 85, -3224, 0, 90, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, 13399, 85, 3318, 0, 173, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, 15005, 85, 12933, 0, 0, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, 3479, 85, 12933, 0, 0, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, -9389, 85, 12933, 0, 0, 0, 0x00000000, bhvRrStart),
		OBJECT(MODEL_NONE, 1185, -2196, 1250, 0, 0, 0, 0x00000000, bhvRrStart),

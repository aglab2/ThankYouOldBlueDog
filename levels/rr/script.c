...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		OBJECT(MODEL_NONE, 12669, -173, 12933, 0, 0, 0, 0x00000000, bhvRrFlipper),
		OBJECT(MODEL_NONE, 10899, -2462, 7455, 0, 0, 0, 0x00000000, bhvCcmUpReset),
		OBJECT(MODEL_NONE, 11357, 912, 12933, 0, 0, 0, (1 << 16), bhvRrFlipper),
		...
		OBJECT(MODEL_NONE, 14536, 85, -13127, 0, -90, 0, 0x00000000, bhvRrMoveCtl),
